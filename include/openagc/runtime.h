...
#define AGC_RUNTIME_API_VERSION 51u
...
typedef enum AgcFormat {
    ...
    AGC_FORMAT_R8_SNORM = 541,
    AGC_FORMAT_R8_UINT = 542,
    AGC_FORMAT_R8_SINT = 543,
    AGC_FORMAT_RG8_SNORM = 544,
    AGC_FORMAT_RG8_UINT = 545,
    AGC_FORMAT_RG8_SINT = 546,
    AGC_FORMAT_RGBA8_SNORM = 547,
    AGC_FORMAT_RGBA8_UINT = 548,
    AGC_FORMAT_RGBA8_SINT = 549,
    AGC_FORMAT_RGB10A2_UINT = 550,
    AGC_FORMAT_BGR10A2_UNORM = 551,
    AGC_FORMAT_R5G6B5_UNORM = 552,
    AGC_FORMAT_B5G6R5_UNORM = 553,
    AGC_FORMAT_R5G5B5A1_UNORM = 554,
    AGC_FORMAT_A1R5G5B5_UNORM = 555,
    AGC_FORMAT_A4B4G4R4_UNORM = 556,
    AGC_FORMAT_R4G4_UNORM = 557
} AgcFormat;
