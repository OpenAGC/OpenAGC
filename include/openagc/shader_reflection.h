...
typedef enum AgcShaderReflectionFlagBits {
    ...
    AGC_SHADER_REFLECTION_ALPHA_TO_ONE_BIT = 1u << 7
...
typedef enum AgcShaderUserSgprKind {
    ...
    AGC_SHADER_USER_SGPR_NUM_WORKGROUPS,
    AGC_SHADER_USER_SGPR_VIEW_INDEX,
...
typedef enum AgcShaderSystemSgprFlagBits {
    ...
    AGC_SHADER_SYSTEM_SGPR_VIEW_INDEX_BIT = UINT64_C(1) << 5
