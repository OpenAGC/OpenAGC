...
#define AGC_REG_DB_RENDER_CONTROL_RESUMMARIZE_ENABLE_SHIFT 4u
#define AGC_REG_DB_RENDER_CONTROL_RESUMMARIZE_ENABLE_MASK  0x1u
#define AGC_REG_DB_RENDER_CONTROL_STENCIL_COMPRESS_DISABLE_SHIFT 5u
#define AGC_REG_DB_RENDER_CONTROL_STENCIL_COMPRESS_DISABLE_MASK  0x1u
#define AGC_REG_DB_RENDER_CONTROL_DEPTH_COMPRESS_DISABLE_SHIFT 6u
#define AGC_REG_DB_RENDER_CONTROL_DEPTH_COMPRESS_DISABLE_MASK  0x1u
#define AGC_REG_DB_RENDER_CONTROL_DECOMPRESS_ENABLE_SHIFT 12u
#define AGC_REG_DB_RENDER_CONTROL_DECOMPRESS_ENABLE_MASK  0x1u
...
#define AGC_REG_DB_Z_INFO_SW_MODE_SHIFT               4u
#define AGC_REG_DB_Z_INFO_SW_MODE_MASK                0x1Fu
...
#define AGC_REG_DB_Z_INFO_ITERATE_256_SHIFT          20u
#define AGC_REG_DB_Z_INFO_ITERATE_256_MASK           0x1u
...
#define AGC_REG_DB_STENCIL_INFO_FORMAT_SHIFT        0u
#define AGC_REG_DB_STENCIL_INFO_FORMAT_MASK         0x1u
#define AGC_REG_DB_STENCIL_INFO_SW_MODE_SHIFT       4u
#define AGC_REG_DB_STENCIL_INFO_SW_MODE_MASK        0x1Fu
#define AGC_REG_DB_STENCIL_INFO_ITERATE_FLUSH_SHIFT 11u
#define AGC_REG_DB_STENCIL_INFO_ITERATE_FLUSH_MASK  0x1u
#define AGC_REG_DB_STENCIL_INFO_PARTIALLY_RESIDENT_SHIFT 12u
#define AGC_REG_DB_STENCIL_INFO_PARTIALLY_RESIDENT_MASK  0x1u
#define AGC_REG_DB_STENCIL_INFO_ITERATE_256_SHIFT   20u
#define AGC_REG_DB_STENCIL_INFO_ITERATE_256_MASK    0x1u
#define AGC_REG_DB_STENCIL_INFO_ALLOW_EXPCLEAR_SHIFT 27u
#define AGC_REG_DB_STENCIL_INFO_ALLOW_EXPCLEAR_MASK  0x1u
#define AGC_REG_DB_STENCIL_INFO_TILE_STENCIL_DISABLE_SHIFT 29u
#define AGC_REG_DB_STENCIL_INFO_TILE_STENCIL_DISABLE_MASK  0x1u
...
/* Equal-quality antialiasing / multisample state. */
#define AGC_REG_DB_EQAA                              0x201u
#define AGC_REG_DB_EQAA_MAX_ANCHOR_SAMPLES_SHIFT    0u
#define AGC_REG_DB_EQAA_MAX_ANCHOR_SAMPLES_MASK     0x7u
#define AGC_REG_DB_EQAA_PS_ITER_SAMPLES_SHIFT       4u
#define AGC_REG_DB_EQAA_PS_ITER_SAMPLES_MASK        0x7u
#define AGC_REG_DB_EQAA_MASK_EXPORT_NUM_SAMPLES_SHIFT 8u
#define AGC_REG_DB_EQAA_MASK_EXPORT_NUM_SAMPLES_MASK  0x7u
#define AGC_REG_DB_EQAA_ALPHA_TO_MASK_NUM_SAMPLES_SHIFT 12u
#define AGC_REG_DB_EQAA_ALPHA_TO_MASK_NUM_SAMPLES_MASK  0x7u

#define AGC_REG_DB_DEPTH_VIEW_SLICE_START_SHIFT       0u
#define AGC_REG_DB_DEPTH_VIEW_SLICE_START_MASK        0x7FFu
#define AGC_REG_DB_DEPTH_VIEW_SLICE_START_HI_SHIFT   11u
#define AGC_REG_DB_DEPTH_VIEW_SLICE_START_HI_MASK     0x3u
#define AGC_REG_DB_DEPTH_VIEW_SLICE_MAX_SHIFT        13u
#define AGC_REG_DB_DEPTH_VIEW_SLICE_MAX_MASK          0x7FFu
#define AGC_REG_DB_DEPTH_VIEW_Z_READ_ONLY_SHIFT      24u
#define AGC_REG_DB_DEPTH_VIEW_Z_READ_ONLY_MASK        0x1u
#define AGC_REG_DB_DEPTH_VIEW_STENCIL_READ_ONLY_SHIFT 25u
#define AGC_REG_DB_DEPTH_VIEW_STENCIL_READ_ONLY_MASK  0x1u
#define AGC_REG_DB_DEPTH_VIEW_MIPID_SHIFT            26u
#define AGC_REG_DB_DEPTH_VIEW_MIPID_MASK              0xFu
#define AGC_REG_DB_DEPTH_VIEW_SLICE_MAX_HI_SHIFT     30u
#define AGC_REG_DB_DEPTH_VIEW_SLICE_MAX_HI_MASK       0x3u

#define AGC_REG_DB_DEPTH_SIZE_XY_X_MAX_SHIFT          0u
#define AGC_REG_DB_DEPTH_SIZE_XY_X_MAX_MASK           0x3FFFu
#define AGC_REG_DB_DEPTH_SIZE_XY_Y_MAX_SHIFT         16u
#define AGC_REG_DB_DEPTH_SIZE_XY_Y_MAX_MASK           0x3FFFu

#define AGC_REG_DB_Z_READ_BASE_HI_BASE_HI_SHIFT       0u
#define AGC_REG_DB_Z_READ_BASE_HI_BASE_HI_MASK        0xFFu
...
/* gfx10.3 raster sample state. Offsets are relative to CX base 0x28000. */
#define AGC_REG_PA_SC_MODE_CNTL_0                   0x292u
#define AGC_REG_PA_SC_MODE_CNTL_0_MSAA_ENABLE_SHIFT 0u
...
#define AGC_REG_PA_SC_AA_CONFIG_MSAA_NUM_SAMPLES_SHIFT 0u
#define AGC_REG_PA_SC_AA_CONFIG_MSAA_NUM_SAMPLES_MASK  0x7u
#define AGC_REG_PA_SC_AA_CONFIG_MAX_SAMPLE_DIST_SHIFT 13u
#define AGC_REG_PA_SC_AA_CONFIG_MAX_SAMPLE_DIST_MASK  0xFu
#define AGC_REG_PA_SC_AA_CONFIG_MSAA_EXPOSED_SAMPLES_SHIFT 20u
#define AGC_REG_PA_SC_AA_CONFIG_MSAA_EXPOSED_SAMPLES_MASK  0x7u
#define AGC_REG_PA_SC_AA_CONFIG_COVERED_CENTROID_IS_CENTER_SHIFT 29u
#define AGC_REG_PA_SC_AA_CONFIG_COVERED_CENTROID_IS_CENTER_MASK  0x1u
#define AGC_REG_PA_SC_AA_SAMPLE_LOCS_PIXEL_X0Y0_0   0x2FEu
#define AGC_REG_PA_SC_AA_SAMPLE_LOCS_PIXEL_X1Y0_0   0x302u
#define AGC_REG_PA_SC_AA_SAMPLE_LOCS_PIXEL_X0Y1_0   0x306u
#define AGC_REG_PA_SC_AA_SAMPLE_LOCS_PIXEL_X1Y1_0   0x30Au
...
#define AGC_REG_SX_MRT0_BLEND_OPT                   0x1D8u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_SRC_OPT_SHIFT     0u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_SRC_OPT_MASK      0x7u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_DST_OPT_SHIFT     4u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_DST_OPT_MASK      0x7u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_COMB_FCN_SHIFT    8u
#define AGC_REG_SX_MRT0_BLEND_OPT_COLOR_COMB_FCN_MASK     0x7u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_SRC_OPT_SHIFT     16u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_SRC_OPT_MASK      0x7u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_DST_OPT_SHIFT     20u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_DST_OPT_MASK      0x7u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_COMB_FCN_SHIFT    24u
#define AGC_REG_SX_MRT0_BLEND_OPT_ALPHA_COMB_FCN_MASK     0x7u
...
#define AGC_REG_CB_BLEND0_CONTROL_DISABLE_ROP3_SHIFT       31u
#define AGC_REG_CB_BLEND0_CONTROL_DISABLE_ROP3_MASK        0x1u

#define AGC_REG_CB_COLOR_CONTROL                     0x202u
#define AGC_REG_CB_COLOR_CONTROL_DISABLE_DUAL_QUAD_SHIFT 0u
#define AGC_REG_CB_COLOR_CONTROL_DISABLE_DUAL_QUAD_MASK  0x1u
...
#define AGC_REG_CB_COLOR0_INFO_SIMPLE_FLOAT_SHIFT   17u
#define AGC_REG_CB_COLOR0_INFO_SIMPLE_FLOAT_MASK    0x1u
...
#define AGC_REG_DB_STENCILREFMASK_TESTVAL_SHIFT       0u
#define AGC_REG_DB_STENCILREFMASK_TESTVAL_MASK      0xFFu
#define AGC_REG_DB_STENCILREFMASK_COMPARE_SHIFT       8u
#define AGC_REG_DB_STENCILREFMASK_COMPARE_MASK      0xFFu
#define AGC_REG_DB_STENCILREFMASK_WRITE_SHIFT        16u
#define AGC_REG_DB_STENCILREFMASK_WRITE_MASK        0xFFu
#define AGC_REG_DB_STENCILREFMASK_OPVAL_SHIFT         24u
#define AGC_REG_DB_STENCILREFMASK_OPVAL_MASK        0xFFu

#define AGC_REG_DB_STENCIL_CONTROL_FAIL_SHIFT          0u
#define AGC_REG_DB_STENCIL_CONTROL_FAIL_MASK          0xFu
#define AGC_REG_DB_STENCIL_CONTROL_ZPASS_SHIFT         4u
#define AGC_REG_DB_STENCIL_CONTROL_ZPASS_MASK         0xFu
#define AGC_REG_DB_STENCIL_CONTROL_ZFAIL_SHIFT         8u
#define AGC_REG_DB_STENCIL_CONTROL_ZFAIL_MASK         0xFu
#define AGC_REG_DB_STENCIL_CONTROL_FAIL_BF_SHIFT      12u
#define AGC_REG_DB_STENCIL_CONTROL_FAIL_BF_MASK       0xFu
#define AGC_REG_DB_STENCIL_CONTROL_ZPASS_BF_SHIFT     16u
#define AGC_REG_DB_STENCIL_CONTROL_ZPASS_BF_MASK      0xFu
#define AGC_REG_DB_STENCIL_CONTROL_ZFAIL_BF_SHIFT     20u
#define AGC_REG_DB_STENCIL_CONTROL_ZFAIL_BF_MASK      0xFu
...
#define AGC_REG_PA_CL_CLIP_CNTL_DX_LINEAR_ATTR_CLIP_ENA_SHIFT   24u
#define AGC_REG_PA_CL_CLIP_CNTL_DX_LINEAR_ATTR_CLIP_ENA_MASK    0x1u
