...
#define AGC_REGISTER_DEFAULTS_VERSION_9    9u
#define AGC_REGISTER_DEFAULTS_VERSION_10   10u
#define AGC_REGISTER_DEFAULTS_VERSION_12   12u

/* Register-defaults table lengths recovered from the versioned tables. */
#define AGC_REGISTER_DEFAULTS_V8_PRIMARY_CX_LENGTH   78u
#define AGC_REGISTER_DEFAULTS_V8_PRIMARY_SH_LENGTH   29u
#define AGC_REGISTER_DEFAULTS_V8_PRIMARY_UC_LENGTH   20u
#define AGC_REGISTER_DEFAULTS_V8_INTERNAL_CX_LENGTH  4u
#define AGC_REGISTER_DEFAULTS_V8_INTERNAL_SH_LENGTH  15u
#define AGC_REGISTER_DEFAULTS_V8_INTERNAL_UC_LENGTH  3u

#define AGC_REGISTER_DEFAULTS_V10_PRIMARY_CX_LENGTH   79u
#define AGC_REGISTER_DEFAULTS_V10_PRIMARY_SH_LENGTH   29u
#define AGC_REGISTER_DEFAULTS_V10_PRIMARY_UC_LENGTH   20u
#define AGC_REGISTER_DEFAULTS_V10_INTERNAL_CX_LENGTH  9u
#define AGC_REGISTER_DEFAULTS_V10_INTERNAL_SH_LENGTH  15u
#define AGC_REGISTER_DEFAULTS_V10_INTERNAL_UC_LENGTH  3u

/* Compatibility aliases for the FW 5.50/version-8 default layout. */
#define AGC_PRIMARY_CX_LENGTH   AGC_REGISTER_DEFAULTS_V8_PRIMARY_CX_LENGTH
#define AGC_PRIMARY_SH_LENGTH   AGC_REGISTER_DEFAULTS_V8_PRIMARY_SH_LENGTH
#define AGC_PRIMARY_UC_LENGTH   AGC_REGISTER_DEFAULTS_V8_PRIMARY_UC_LENGTH
#define AGC_INTERNAL_CX_LENGTH  AGC_REGISTER_DEFAULTS_V8_INTERNAL_CX_LENGTH
#define AGC_INTERNAL_SH_LENGTH  AGC_REGISTER_DEFAULTS_V8_INTERNAL_SH_LENGTH
#define AGC_INTERNAL_UC_LENGTH  AGC_REGISTER_DEFAULTS_V8_INTERNAL_UC_LENGTH
