...
- NID table (FW 5.50): 340 identified exports (213 libSceAgc + 127 libSceAgcDriver) out of 366 total FW 5.50 SPRX exports (92.9% coverage). Sources: KytyPS5 LIB_FUNC, ps5-openagc agc_nid.h, FW 3.20 genstub files, SPRX disassembly. Remaining 26 unknown NIDs are functions new in FW 5.50 (not in 3.20 stubs). Version-specific NIDs (3.20-only, 11.60-only) are in `analysis/agc_nids_version_variants.tsv`.
