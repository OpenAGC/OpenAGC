...
- NID table expanded to 354 identified exports (225 libSceAgc + 129 libSceAgcDriver) out of 366 total SPRX exports (92% coverage). Sources: KytyPS5 LIB_FUNC, ps5-openagc agc_nid.h, FW 3.20 genstub stub files, SPRX disassembly, and version-specific NID mappings. Remaining 26 unknown NIDs are functions new in FW 5.50 (not in 3.20 stubs).
