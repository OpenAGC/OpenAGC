...
public TF-ring, HS-offchip, and async carrier-qualified subset. Matching
...
public TF-ring, HS-offchip, and async subset; only hardware-qualified `0x0550`
and the deeper exact-RE-qualified `0x1160` profile enable additional operations.
