...
static void test_common_operation_carrier_profiles(void)
{
    ...
    for (size_t i = 0; i < sizeof(active_raw_versions) /
        ...
        AgcGfx1013ColorTargetFormatInfo r32_uint_info;
        AgcGfx1013ColorTargetState r32_uint_target;
        AgcGfx1013ColorTargetFormatInfo rg32_uint_info;
        ...
        AgcGfx1013ColorTargetFormatInfo rg32_sint_info;
        AgcGfx1013ColorTargetState rg32_sint_target;
        AgcGfx1013ColorTargetFormatInfo rgba32_sint_info;
        AgcGfx1013ColorTargetState rgba32_sint_target;
        ...
        TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
            AGC_GFX1013_RT_FORMAT_R32_UINT, &r32_uint_info), AGC_OK,
            "firmware-neutral R32 UINT tuple resolves for active profile");
        TEST_ASSERT_EQ(r32_uint_info.color_format,
            AGC_GFX1013_COLOR_FORMAT_32,
            "active profile shares the gfx1013 unsigned 32-bit encoding");
        TEST_ASSERT_EQ(r32_uint_info.number_type,
            AGC_GFX1013_SURFACE_NUMBER_UINT,
            "active profile shares the 32-bit UINT number encoding");
        TEST_ASSERT_EQ(r32_uint_info.bytes_per_pixel, 4u,
            "active profile shares the four-byte R32 UINT element size");
        TEST_ASSERT_EQ(r32_uint_info.spi_shader_export_format,
            AGC_GFX1013_SPI_EXPORT_32_R,
            "active profile shares the R32 export encoding");
        TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&r32_uint_target,
            UINT64_C(0x0000000201000000), 1536u, 1536u,
            AGC_GFX1013_RT_FORMAT_R32_UINT), AGC_OK,
            "firmware-neutral R32 UINT target initializes");
        TEST_ASSERT_EQ(r32_uint_target.number_type,
            AGC_GFX1013_SURFACE_NUMBER_UINT,
            "active profile receives the same typed R32 UINT state");
        TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
            AGC_GFX1013_RT_FORMAT_RG32_UINT, &rg32_uint_info), AGC_OK,
            "firmware-neutral RG32 UINT tuple resolves for active profile");
        TEST_ASSERT_EQ(rg32_uint_info.color_format,
            AGC_GFX1013_COLOR_FORMAT_32_32,
            "active profile shares the gfx1013 unsigned 32+32 encoding");
        TEST_ASSERT_EQ(rg32_uint_info.number_type,
            AGC_GFX1013_SURFACE_NUMBER_UINT,
            "active profile shares the two-channel 32-bit UINT encoding");
        TEST_ASSERT_EQ(rg32_uint_info.bytes_per_pixel, 8u,
            "active profile shares the eight-byte RG32 UINT element size");
        TEST_ASSERT_EQ(rg32_uint_info.spi_shader_export_format,
            AGC_GFX1013_SPI_EXPORT_32_GR,
            "active profile shares the RG32 export encoding");
        TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&rg32_uint_target,
            UINT64_C(0x0000000201000000), 1536u, 1536u,
            AGC_GFX1013_RT_FORMAT_RG32_UINT), AGC_OK,
            "firmware-neutral RG32 UINT target initializes");
        TEST_ASSERT_EQ(rg32_uint_target.number_type,
            AGC_GFX1013_SURFACE_NUMBER_UINT,
            "active profile receives the same typed RG32 UINT state");
        TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
            AGC_GFX1013_RT_FORMAT_RGBA32_UINT, &rgba32_uint_info), AGC_OK,
            "firmware-neutral RGBA32 UINT tuple resolves for active profile");
        TEST_ASSERT_EQ(rgba32_uint_info.color_format,
            AGC_GFX1013_COLOR_FORMAT_32_32_32_32,
            "active profile shares the gfx1013 unsigned 32x4 encoding");
        TEST_ASSERT_EQ(rgba32_uint_info.number_type,
            AGC_GFX1013_SURFACE_NUMBER_UINT,
            "active profile shares the four-channel 32-bit UINT encoding");
        TEST_ASSERT_EQ(rgba32_uint_info.bytes_per_pixel, 16u,
            "active profile shares the 16-byte RGBA32 UINT element size");
        TEST_ASSERT_EQ(rgba32_uint_info.spi_shader_export_format,
            AGC_GFX1013_SPI_EXPORT_32_ABGR,
            "active profile shares the RGBA32 export encoding");
        TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&rgba32_uint_target,
            UINT64_C(0x0000000201000000), 1536u, 1536u,
            AGC_GFX1013_RT_FORMAT_RGBA32_UINT), AGC_OK,
            "firmware-neutral RGBA32 UINT target initializes");
        ...
        TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
            AGC_GFX1013_RT_FORMAT_RG32_SINT, &rg32_sint_info), AGC_OK,
            "firmware-neutral RG32 SINT tuple resolves for active profile");
        TEST_ASSERT_EQ(rg32_sint_info.color_format,
            AGC_GFX1013_COLOR_FORMAT_32_32,
            "active profile shares the gfx1013 signed 32+32 encoding");
        TEST_ASSERT_EQ(rg32_sint_info.number_type,
            AGC_GFX1013_SURFACE_NUMBER_SINT,
            "active profile shares the two-channel 32-bit SINT encoding");
        TEST_ASSERT_EQ(rg32_sint_info.bytes_per_pixel, 8u,
            "active profile shares the eight-byte RG32 SINT element size");
        TEST_ASSERT_EQ(rg32_sint_info.spi_shader_export_format,
            AGC_GFX1013_SPI_EXPORT_32_GR,
            "active profile shares the signed RG32 export encoding");
        TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&rg32_sint_target,
            UINT64_C(0x0000000201000000), 1536u, 1536u,
            AGC_GFX1013_RT_FORMAT_RG32_SINT), AGC_OK,
            "firmware-neutral RG32 SINT target initializes");
        TEST_ASSERT_EQ(rg32_sint_target.number_type,
            AGC_GFX1013_SURFACE_NUMBER_SINT,
            "active profile receives the same typed RG32 SINT state");
        TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
            AGC_GFX1013_RT_FORMAT_RGBA32_SINT, &rgba32_sint_info), AGC_OK,
            "firmware-neutral RGBA32 SINT tuple resolves for active profile");
        TEST_ASSERT_EQ(rgba32_sint_info.color_format,
            AGC_GFX1013_COLOR_FORMAT_32_32_32_32,
            "active profile shares the gfx1013 signed 32x4 encoding");
        TEST_ASSERT_EQ(rgba32_sint_info.number_type,
            AGC_GFX1013_SURFACE_NUMBER_SINT,
            "active profile shares the four-channel 32-bit SINT encoding");
        TEST_ASSERT_EQ(rgba32_sint_info.bytes_per_pixel, 16u,
            "active profile shares the 16-byte RGBA32 SINT element size");
        TEST_ASSERT_EQ(rgba32_sint_info.spi_shader_export_format,
            AGC_GFX1013_SPI_EXPORT_32_ABGR,
            "active profile shares the signed RGBA32 export encoding");
        TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&rgba32_sint_target,
            UINT64_C(0x0000000201000000), 1536u, 1536u,
            AGC_GFX1013_RT_FORMAT_RGBA32_SINT), AGC_OK,
            "firmware-neutral RGBA32 SINT target initializes");
        TEST_ASSERT_EQ(rgba32_sint_target.number_type,
            AGC_GFX1013_SURFACE_NUMBER_SINT,
            "active profile receives the same typed RGBA32 SINT state");
        TEST_ASSERT((profile.capabilities & AGC_DIRECT_CAP_TF_RING) != 0,
