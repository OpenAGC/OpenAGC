...
static void test_gfx1013_fixed_function_packets(void)
{
    static const struct {
        ...
        {AGC_GFX1013_RT_FORMAT_BGRA8_UNORM, 0x0au, 0u, 1u, 4u, 4u,
         0x00028828u},
        {AGC_GFX1013_RT_FORMAT_RGB10A2_UNORM, 0x09u, 0u, 0u, 4u, 4u,
         0x00028024u},
        ...
        {AGC_GFX1013_RT_FORMAT_RGBA16_UNORM, 0x0cu, 0u, 0u, 8u, 4u,
         0x00028030u},
        {AGC_GFX1013_RT_FORMAT_R16_SNORM, 0x02u, 1u, 0u, 2u, 4u,
         0x00028108u},
        {AGC_GFX1013_RT_FORMAT_RG16_SNORM, 0x05u, 1u, 0u, 4u, 4u,
         0x00028114u},
        {AGC_GFX1013_RT_FORMAT_RGBA16_SNORM, 0x0cu, 1u, 0u, 8u, 4u,
         0x00028130u},
        {AGC_GFX1013_RT_FORMAT_R16_UINT, 0x02u, 4u, 0u, 2u, 7u,
         0x00070408u},
        {AGC_GFX1013_RT_FORMAT_RG16_UINT, 0x05u, 4u, 0u, 4u, 7u,
         0x00070414u},
        {AGC_GFX1013_RT_FORMAT_RGBA16_UINT, 0x0cu, 4u, 0u, 8u, 7u,
         0x00070430u},
        {AGC_GFX1013_RT_FORMAT_R16_SINT, 0x02u, 5u, 0u, 2u, 8u,
         0x00070508u},
        {AGC_GFX1013_RT_FORMAT_RG16_SINT, 0x05u, 5u, 0u, 4u, 8u,
         0x00070514u},
        {AGC_GFX1013_RT_FORMAT_RGBA16_SINT, 0x0cu, 5u, 0u, 8u, 8u,
         0x00070530u},
        {AGC_GFX1013_RT_FORMAT_R32_UINT, 0x04u, 4u, 0u, 4u, 1u,
         0x00070410u},
        {AGC_GFX1013_RT_FORMAT_RG32_UINT, 0x0bu, 4u, 0u, 8u, 2u,
         0x0007042cu},
        {AGC_GFX1013_RT_FORMAT_RGBA32_UINT, 0x0eu, 4u, 0u, 16u, 9u,
         0x00070438u},
        {AGC_GFX1013_RT_FORMAT_R32_SINT, 0x04u, 5u, 0u, 4u, 1u,
         0x00070510u},
        {AGC_GFX1013_RT_FORMAT_RG32_SINT, 0x0bu, 5u, 0u, 8u, 2u,
         0x0007052cu},
        ...
        {AGC_GFX1013_RT_FORMAT_RG8_SINT, 0x03u, 5u, 0u, 2u, 8u,
         0x0007050cu},
        {AGC_GFX1013_RT_FORMAT_RGBA8_SNORM, 0x0au, 1u, 0u, 4u, 4u,
         0x00028128u},
        {AGC_GFX1013_RT_FORMAT_RGBA8_UINT, 0x0au, 4u, 0u, 4u, 7u,
         0x00070428u},
        {AGC_GFX1013_RT_FORMAT_RGBA8_SINT, 0x0au, 5u, 0u, 4u, 8u,
         0x00070528u},
        {AGC_GFX1013_RT_FORMAT_RGB10A2_UINT, 0x09u, 4u, 0u, 4u, 7u,
         0x00070424u},
        {AGC_GFX1013_RT_FORMAT_BGR10A2_UNORM, 0x09u, 0u, 1u, 4u, 4u,
         0x00028824u},
    ...
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_R16_SNORM,
        17u, "gfx1013 R16 SNORM enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RG16_SNORM,
        18u, "gfx1013 RG16 SNORM enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA16_SNORM,
        19u, "gfx1013 RGBA16 SNORM enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_R16_UINT,
        20u, "gfx1013 R16 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RG16_UINT,
        21u, "gfx1013 RG16 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA16_UINT,
        22u, "gfx1013 RGBA16 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_R16_SINT,
    ...
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_R32_UINT,
        26u, "gfx1013 R32 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RG32_UINT,
        27u, "gfx1013 RG32 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA32_UINT,
        28u, "gfx1013 RGBA32 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_R32_SINT,
        29u, "gfx1013 R32 SINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RG32_SINT,
    ...
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA8_SNORM,
        38u, "gfx1013 RGBA8 SNORM enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA8_UINT,
        39u, "gfx1013 RGBA8 UINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGBA8_SINT,
        40u, "gfx1013 RGBA8 SINT enum is appended");
    TEST_ASSERT_EQ((uint32_t)AGC_GFX1013_RT_FORMAT_RGB10A2_UINT,
    ...
    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        ...
        "gfx1013 R16 UNORM boundary target initializes");
    agcCbReset(&cb, buffer, 27u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
        AGC_ERROR_BUFFER_TOO_SMALL,
        "gfx1013 R16 UNORM rejects a one-dword-short buffer");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
        "gfx1013 short R16 UNORM emission is atomic");
    typed_color.address |= 1u;
    agcCbReset(&cb, buffer, sizeof(buffer));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
        AGC_ERROR_INVALID_ALIGNMENT,
        "gfx1013 R16 UNORM rejects an unaligned target");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
        "gfx1013 invalid R16 UNORM target is atomic");
    memset(&format_info, 0xa5, sizeof(format_info));
    TEST_ASSERT_EQ(agcGfx1013GetColorTargetFormatInfo(
    ...
    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_R16_SNORM), AGC_OK,
        "gfx1013 R16 SNORM boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 R16 SNORM rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short R16 SNORM emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short R16 SNORM emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 R16 SNORM emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 R16 SNORM exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RG16_SNORM), AGC_OK,
        "gfx1013 RG16 SNORM boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RG16 SNORM rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RG16 SNORM emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RG16 SNORM emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RG16 SNORM emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RG16 SNORM exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RGBA16_SNORM), AGC_OK,
        "gfx1013 RGBA16 SNORM boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RGBA16 SNORM rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RGBA16 SNORM emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RGBA16 SNORM emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RGBA16 SNORM emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RGBA16 SNORM exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_R16_UINT), AGC_OK,
        "gfx1013 R16 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 R16 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short R16 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short R16 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 R16 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 R16 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RG16_UINT), AGC_OK,
        "gfx1013 RG16 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RG16 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RG16 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RG16 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RG16 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RG16 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RGBA16_UINT), AGC_OK,
        "gfx1013 RGBA16 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RGBA16 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RGBA16 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RGBA16 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RGBA16 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RGBA16 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_R16_SINT), AGC_OK,
        "gfx1013 R16 SINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 R16 SINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short R16 SINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short R16 SINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 R16 SINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 R16 SINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RG16_SINT), AGC_OK,
        "gfx1013 RG16 SINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RG16 SINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RG16 SINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RG16 SINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
    ...
    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_R32_UINT), AGC_OK,
        "gfx1013 R32 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 R32 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short R32 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short R32 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 R32 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 R32 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RG32_UINT), AGC_OK,
        "gfx1013 RG32 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RG32 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RG32 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RG32 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RG32 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RG32 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RGBA32_UINT), AGC_OK,
        "gfx1013 RGBA32 UINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RGBA32 UINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RGBA32 UINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RGBA32 UINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RGBA32 UINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RGBA32 UINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_R32_SINT), AGC_OK,
        "gfx1013 R32 SINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 R32 SINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short R32 SINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short R32 SINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 R32 SINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 R32 SINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RG32_SINT), AGC_OK,
        "gfx1013 RG32 SINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RG32 SINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RG32 SINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RG32 SINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RG32 SINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RG32 SINT exact capacity advances cursor");

    TEST_ASSERT_EQ(agcGfx1013InitColorTarget(&typed_color, color.address,
        2048u, color.height, AGC_GFX1013_RT_FORMAT_RGBA32_SINT), AGC_OK,
        "gfx1013 RGBA32 SINT boundary target initializes");
    for (i = 0u; i < 28u; ++i) {
        memset(buffer, 0xa5, sizeof(buffer));
        agcCbReset(&cb, buffer, i * sizeof(uint32_t));
        TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color),
            AGC_ERROR_BUFFER_TOO_SMALL,
            "gfx1013 RGBA32 SINT rejects every short-buffer boundary");
        TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 0u,
            "gfx1013 short RGBA32 SINT emission preserves cursor");
        TEST_ASSERT_EQ(buffer[0], 0xa5a5a5a5u,
            "gfx1013 short RGBA32 SINT emission preserves command memory");
    }
    agcCbReset(&cb, buffer, 28u * sizeof(uint32_t));
    TEST_ASSERT_EQ(agcGfx1013SetColorTarget(&cb, &typed_color), AGC_OK,
        "gfx1013 RGBA32 SINT emits at exact required capacity");
    TEST_ASSERT_EQ(agcCbUsedDwords(&cb), 28u,
        "gfx1013 RGBA32 SINT exact capacity advances cursor");
...
static void test_gfx1013_msaa_state_and_layout(void)
{
    ...
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_R16_SNORM;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x R16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 R16 SNORM layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 R16 SNORM padded height");
    TEST_ASSERT_EQ(layout.block_width, 128u,
        "gfx1013 R16 SNORM block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 R16 SNORM block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(16711680),
        "gfx1013 R16 SNORM exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(16711680),
        "gfx1013 R16 SNORM exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum R16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(2147483648),
        "gfx1013 maximum R16 SNORM slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(17592186044416),
        "gfx1013 maximum R16 SNORM allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized R16 SNORM layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected R16 SNORM layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RG16_SNORM;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RG16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RG16 SNORM layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RG16 SNORM padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RG16 SNORM block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 RG16 SNORM block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(33423360),
        "gfx1013 RG16 SNORM exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(33423360),
        "gfx1013 RG16 SNORM exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RG16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(4294967296),
        "gfx1013 maximum RG16 SNORM slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(35184372088832),
        "gfx1013 maximum RG16 SNORM allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RG16 SNORM layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RG16 SNORM layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RGBA16_SNORM;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RGBA16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RGBA16 SNORM layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RGBA16 SNORM padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RGBA16 SNORM block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RGBA16 SNORM block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(66846720),
        "gfx1013 RGBA16 SNORM exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(66846720),
        "gfx1013 RGBA16 SNORM exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RGBA16 SNORM layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(8589934592),
        "gfx1013 maximum RGBA16 SNORM slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(70368744177664),
        "gfx1013 maximum RGBA16 SNORM allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RGBA16 SNORM layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RGBA16 SNORM layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_R16_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x R16 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 R16 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 R16 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 128u,
        "gfx1013 R16 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 R16 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(16711680),
        "gfx1013 R16 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(16711680),
        "gfx1013 R16 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum R16 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(2147483648),
        "gfx1013 maximum R16 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(17592186044416),
        "gfx1013 maximum R16 UINT allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized R16 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected R16 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RG16_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RG16 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RG16 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RG16 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RG16 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 RG16 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(33423360),
        "gfx1013 RG16 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(33423360),
        "gfx1013 RG16 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RG16 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(4294967296),
        "gfx1013 maximum RG16 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(35184372088832),
        "gfx1013 maximum RG16 UINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RG16 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RG16 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RGBA16_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RGBA16 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RGBA16 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RGBA16 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RGBA16 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RGBA16 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(66846720),
        "gfx1013 RGBA16 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(66846720),
        "gfx1013 RGBA16 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RGBA16 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(8589934592),
        "gfx1013 maximum RGBA16 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(70368744177664),
        "gfx1013 maximum RGBA16 UINT allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RGBA16 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RGBA16 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_R16_SINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x R16 SINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 R16 SINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 R16 SINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 128u,
        "gfx1013 R16 SINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 R16 SINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(16711680),
        "gfx1013 R16 SINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(16711680),
        "gfx1013 R16 SINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum R16 SINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(2147483648),
        "gfx1013 maximum R16 SINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(17592186044416),
        "gfx1013 maximum R16 SINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized R16 SINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected R16 SINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RG16_SINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RG16 SINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RG16 SINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RG16 SINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RG16 SINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 RG16 SINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(33423360),
        "gfx1013 RG16 SINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(33423360),
        "gfx1013 RG16 SINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RG16 SINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(4294967296),
        "gfx1013 maximum RG16 SINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(35184372088832),
        "gfx1013 maximum RG16 SINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
    ...
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_R32_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x R32 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 R32 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 R32 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 R32 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 R32 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(33423360),
        "gfx1013 R32 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(33423360),
        "gfx1013 R32 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum R32 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(4294967296),
        "gfx1013 maximum R32 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(35184372088832),
        "gfx1013 maximum R32 UINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized R32 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected R32 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RG32_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RG32 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RG32 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RG32 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RG32 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RG32 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(66846720),
        "gfx1013 RG32 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(66846720),
        "gfx1013 RG32 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RG32 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(8589934592),
        "gfx1013 maximum RG32 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(70368744177664),
        "gfx1013 maximum RG32 UINT allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RG32 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RG32 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RGBA32_UINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RGBA32 UINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RGBA32 UINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RGBA32 UINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 32u,
        "gfx1013 RGBA32 UINT block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RGBA32 UINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(133693440),
        "gfx1013 RGBA32 UINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(133693440),
        "gfx1013 RGBA32 UINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RGBA32 UINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(17179869184),
        "gfx1013 maximum RGBA32 UINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(140737488355328),
        "gfx1013 maximum RGBA32 UINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RGBA32 UINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RGBA32 UINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_R32_SINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x R32 SINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 R32 SINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 R32 SINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 R32 SINT block width");
    TEST_ASSERT_EQ(layout.block_height, 64u,
        "gfx1013 R32 SINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(33423360),
        "gfx1013 R32 SINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(33423360),
        "gfx1013 R32 SINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum R32 SINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(4294967296),
        "gfx1013 maximum R32 SINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(35184372088832),
        "gfx1013 maximum R32 SINT allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized R32 SINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected R32 SINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RG32_SINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RG32 SINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u,
        "gfx1013 RG32 SINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RG32 SINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 64u,
        "gfx1013 RG32 SINT block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RG32 SINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(66846720),
        "gfx1013 RG32 SINT exact 64-bit slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(66846720),
        "gfx1013 RG32 SINT exact allocation size");

    input.width = 0x4000u;
    input.height = 0x4000u;
    input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 maximum RG32 SINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(8589934592),
        "gfx1013 maximum RG32 SINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(70368744177664),
        "gfx1013 maximum RG32 SINT allocation does not overflow");
    input.height++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RG32 SINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RG32 SINT layout preserves output");

    input.width = 1920u;
    input.height = 1080u;
    input.layer_count = 1u;
    input.format = AGC_GFX1013_RT_FORMAT_RGBA32_SINT;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_OK, "gfx1013 4x RGBA32 SINT layout computes");
    TEST_ASSERT_EQ(layout.pitch, 1920u, "gfx1013 RGBA32 SINT layout pitch");
    TEST_ASSERT_EQ(layout.padded_height, 1088u,
        "gfx1013 RGBA32 SINT padded height");
    TEST_ASSERT_EQ(layout.block_width, 32u,
        "gfx1013 RGBA32 SINT block width");
    TEST_ASSERT_EQ(layout.block_height, 32u,
        "gfx1013 RGBA32 SINT block height");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(133693440),
        "gfx1013 RGBA32 SINT exact slice size");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(133693440),
        "gfx1013 RGBA32 SINT exact allocation size");
    input.width = 0x4000u; input.height = 0x4000u; input.layer_count = 0x2000u;
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout), AGC_OK,
        "gfx1013 maximum RGBA32 SINT layout computes");
    TEST_ASSERT_EQ(layout.slice_size, UINT64_C(17179869184),
        "gfx1013 maximum RGBA32 SINT slice does not truncate");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(140737488355328),
        "gfx1013 maximum RGBA32 SINT allocation does not overflow");
    input.width++;
    memset(&layout, 0xa5, sizeof(layout));
    TEST_ASSERT_EQ(agcGfx1013GetColorSurfaceLayout(&input, &layout),
        AGC_ERROR_INVALID_ARGUMENT,
        "gfx1013 oversized RGBA32 SINT layout rejects before arithmetic");
    TEST_ASSERT_EQ(layout.allocation_size, UINT64_C(0xa5a5a5a5a5a5a5a5),
        "gfx1013 rejected RGBA32 SINT layout preserves output");
