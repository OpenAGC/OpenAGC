...
static void test_runtime_regular_color_sampled_image_views(void)
{
    ...
    static const RuntimeSampledFormatCase cases[] = {
        ...
        {AGC_FORMAT_RGBA8_SNORM, AGC_GFX1013_IMAGE_FORMAT_RGBA8_SNORM, 0u},
        {AGC_FORMAT_RGBA8_UINT, AGC_GFX1013_IMAGE_FORMAT_RGBA8_UINT, 0u},
        {AGC_FORMAT_RGBA8_SINT, AGC_GFX1013_IMAGE_FORMAT_RGBA8_SINT, 0u},
